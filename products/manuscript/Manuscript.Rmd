---
title: "Example Manuscript Template for Module 2 Analysis"
subtitle: ""
author: Group 2
date: "`r Sys.Date()`"
...
Figure \@ref(fig:resultfigure) shows a scatterplot figure produced with data based on Gender.

```{r resultfigure,  fig.cap='Analysis the relationship between Age and Weight between Males and Females.', echo=FALSE}
knitr::include_graphics("../../results/ScatterPlot.png")
```

Figure \@ref(fig:resultfigure) shows a Box plot figure produced with data based on Gender.

```{r resultfigure_2,  fig.cap='Box Plot of Height Distrubution between Males and Females.', echo=FALSE}
