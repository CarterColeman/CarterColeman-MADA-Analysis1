...
Figure \@ref(fig:resultfigure1) shows a Box plot figure produced with data based on Gender.

```{r resultfigure1,  fig.cap='Box Plot of Height Distrubution between Males and Females.', echo=FALSE}
